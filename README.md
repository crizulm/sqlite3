...
Antes de comenzar a trabajar con SQLite vamos a mencionar lo que debemos tener instalado en nuestra maquina, y explicar que función cumple cada uno de estos.
 ...
 - [**SQLite:**](https://github.com/crizulm/sqlite3/tree/shortWorkGuide/download/sqlite.zip) Es nuestro sistema de gestión de base de datos que mencionamos anteriormente.
 - [**JDBC (Java Database Conectivity):**](https://github.com/crizulm/sqlite3/tree/shortWorkGuide/download/sqlite-jdbc-3.20.0.jar.zip) Es una API que permite la ejecución de operaciones sobre nuestra base de datos desde Java, es la que ira a "hablar" con nuestra base de datos.

Para descargar estas herramientas simplemente basta hacer clic encima del titulo de cada una, o en caso contrario hacer [click aquí](https://github.com/crizulm/sqlite3/tree/shortWorkGuide/download) para ver todos las descargas.
